...
//        }
    ...
    public Response methodArgumentTypeInvalidFormatExceptionHandler(HttpMessageNotReadableException ex) {
        log.warn("[methodArgumentTypeInvalidFormatExceptionHandler] {}", ex.getMessage());
    ...
    public Response accessDeniedExceptionHandler(HttpServletRequest req, AccessDeniedException ex) {
        log.warn("[accessDeniedExceptionHandler][userId({}) not able to access url({})]",
                req.getAttribute("login_user_id"),
    ...
    public Response businessExceptionHandler(BusinessException ex) {
        log.warn("[businessExceptionHandler] {}", ex.getMessage()); // 警告级别，无需堆栈
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    private Response noSuchElementExceptionHandler(NoSuchElementException ex)  {
        log.warn("[noSuchElementExceptionHandler] {}", ex.getMessage());
        return (new Response("NOT_FOUND", ex.getMessage()));
    }
